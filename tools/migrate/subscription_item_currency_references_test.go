		...
		stops: stops{
			{
				...
				// Before: 20260728103546_product_catalog_currency_constraints.up.sql
				// After: 20260730105630_add_subscription_item_currency_references.up.sql
				// and 20260730105901_add_subscription_item_currency_constraints.up.sql
